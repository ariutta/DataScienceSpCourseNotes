...
#   p_load("manipulate"); manipulate(myHist(mu), mu = slider(62, 74, step = 0.5))]
...
# "p_load("manipulate")" is needed to use the manipulate function
manipulate(
