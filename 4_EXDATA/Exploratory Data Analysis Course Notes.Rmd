...
* `p_load("lattice")` = load lattice system
...
* `p_load("ggplot2")` = loads ggplot2 package
...
```{r fig.height=3,fig.width=5, fig.align='center'}
## The "impute" library is available from http://bioconductor.org
## biocLite() is the recommended way to install Bioconductor packages.
## If the "impute" library is not already installed, you can uncomment
## the following lines to install it from Bioconductor.
#source("http://bioconductor.org/biocLite.R")
#biocLite(c("impute")) # install "impute" library
library(impute) 
data2 <- dataOrdered
